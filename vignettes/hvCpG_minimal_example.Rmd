...
### Plot sd of raw values for an extremely stable, a mid variable and an extremely variable CpG
...
ggplot2::ggplot(mat_df[mat_df$CpG %in% c(sta, mid, var),], ggplot2::aes(x=dataset, y = sd))+
  ggplot2::geom_col(ggplot2::aes(fill=CpG), position = "dodge")+
  ggplot2::theme_minimal(base_size = 14)+
